...
module.exports = defineConfig({
  ...
  webServer:[
    ...
    {command:'node scripts/serve-escape-room-stream.cjs --port=4177',url:'http://127.0.0.1:4177/escape-room/health',timeout:60000,reuseExistingServer:false,stdout:'pipe',stderr:'pipe'}
  ],
  reporter:[['list']]
});

...
module.exports = defineConfig({
  ...
  webServer:[
    ...
    {command:'node scripts/serve-battle-royale-stream.cjs --port=4177',url:'http://127.0.0.1:4177/battle/health',timeout:60000,reuseExistingServer:false,stdout:'pipe',stderr:'pipe'}
  ],
  reporter:[['list']]
});

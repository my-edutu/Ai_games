...
module.exports = defineConfig({
  ...
  webServer:[
    ...
    {command:'node games/marble-survival-tournament/scripts/serve-complete-runtime.cjs',url:'http://127.0.0.1:4317/api/health',timeout:60000,reuseExistingServer:false,stdout:'pipe',stderr:'pipe'}
  ],
  reporter:[['list']]
});

...
module.exports = defineConfig({
  ...
  webServer:[
    ...
    {command:'node scripts/serve-ant-colony-stream.cjs',url:'http://127.0.0.1:4175/ant/health',timeout:60000,reuseExistingServer:false,stdout:'pipe',stderr:'pipe',env:{...process.env,ANT_EVIDENCE_MODE:'1'}},

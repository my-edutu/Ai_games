...
const BASE_CONTRACTS: readonly BaseHazardContract[] = Object.freeze([
  { id: "hazard-danfo-01", family: "danfo-pull-out", baseX: 10, y: 0, width: 1.8, height: 1.7, warningDistance: 5.5, minResponseTicks: 24, legalResponses: ["slow", "wait"], consequence: "stumble", captionKey: "hazard.danfo", visualToken: "danfo-yellow", maxHazardSpeed: 1.5, motion: { minOffsetX: -1, maxOffsetX: 1, periodTicks: 180, activeTicks: 120 } },
  { id: "hazard-molue-01", family: "molue-crossing", baseX: 20, y: 0, width: 2.4, height: 2.2, warningDistance: 5.5, minResponseTicks: 30, legalResponses: ["wait"], consequence: "fail", captionKey: "hazard.molue", visualToken: "molue-large", maxHazardSpeed: 1, motion: { minOffsetX: -0.8, maxOffsetX: 0.8, periodTicks: 240, activeTicks: 150 } },
  { id: "hazard-pothole-01", family: "pothole", baseX: 30, y: 0, width: 1.1, height: 0.25, warningDistance: 5.5, minResponseTicks: 24, legalResponses: ["jump"], consequence: "stumble", captionKey: "hazard.pothole", visualToken: "road-pothole", maxHazardSpeed: 0 },
  { id: "hazard-drain-01", family: "open-drain", baseX: 40, y: 0, width: 1.35, height: 0.35, warningDistance: 5.5, minResponseTicks: 30, legalResponses: ["jump"], consequence: "fail", captionKey: "hazard.open-drain", visualToken: "open-drain", maxHazardSpeed: 0 },
  { id: "hazard-trench-01", family: "construction-trench", baseX: 50, y: 0, width: 1.45, height: 0.45, warningDistance: 5.5, minResponseTicks: 30, legalResponses: ["jump"], consequence: "fail", captionKey: "hazard.trench", visualToken: "construction-trench", maxHazardSpeed: 0 },
  { id: "hazard-flood-01", family: "flood-puddle", baseX: 60, y: 0, width: 2.4, height: 0.18, warningDistance: 5.5, minResponseTicks: 24, legalResponses: ["slow", "jump"], consequence: "slow", captionKey: "hazard.flood", visualToken: "flood-water", maxHazardSpeed: 0 },
  { id: "hazard-handcart-01", family: "handcart", baseX: 70, y: 0, width: 1.2, height: 1.15, warningDistance: 5.5, minResponseTicks: 24, legalResponses: ["slow", "wait"], consequence: "stumble", captionKey: "hazard.handcart", visualToken: "street-handcart", maxHazardSpeed: 1, motion: { minOffsetX: -0.6, maxOffsetX: 0.6, periodTicks: 180, activeTicks: 120 } },
  { id: "hazard-rolling-01", family: "rolling-object", baseX: 80, y: 0, width: 0.7, height: 0.7, warningDistance: 5.5, minResponseTicks: 24, legalResponses: ["jump", "wait"], consequence: "stumble", captionKey: "hazard.rolling", visualToken: "rolling-object", maxHazardSpeed: 2.1, motion: { minOffsetX: -1, maxOffsetX: 1, periodTicks: 120, activeTicks: 90 } },
  { id: "hazard-crowd-01", family: "crowd-compression", baseX: 90, y: 0, width: 2, height: 1.8, warningDistance: 5.5, minResponseTicks: 24, legalResponses: ["slow"], consequence: "slow", captionKey: "hazard.crowd", visualToken: "crowd-compression", maxHazardSpeed: 0.6, motion: { minOffsetX: -0.4, maxOffsetX: 0.4, periodTicks: 180, activeTicks: 150 } },
  { id: "hazard-disturbance-01", family: "street-disturbance", baseX: 100, y: 0, width: 1.8, height: 1.7, warningDistance: 5.5, minResponseTicks: 24, legalResponses: ["slow", "wait"], consequence: "slow", captionKey: "hazard.disturbance", visualToken: "street-disturbance", maxHazardSpeed: 0 },
  { id: "hazard-block-01", family: "temporary-block", baseX: 110, y: 0, width: 1.4, height: 0.85, warningDistance: 5.5, minResponseTicks: 30, legalResponses: ["wait", "vault"], consequence: "stumble", captionKey: "hazard.temporary-block", visualToken: "temporary-block", maxHazardSpeed: 0 },
]);

...
export function App() {
  ...
  return (
    <main className="app-shell">
      ...
      {state.stage === 'artifacts' && !tabletOpen && <div className="artifact-banner"><div><b>Crisis stabilized or handed off.</b><span>Your work is not finished until the evidence becomes usable project records.</span></div><button className="primary" onClick={() => setTabletOpen(true)}>Open Artifacts</button></div>}

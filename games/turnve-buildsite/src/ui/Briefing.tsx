  ...
  return (
    <div className="modal-backdrop">
      <section className="modal briefing briefing-human" role="dialog" aria-modal="true" aria-labelledby="briefing-title">
        ...
        <p className="quote">“{learnerName || 'Intern'}, help us prepare the ground-floor slab for a safe, approved, and properly documented concrete pour. Observe and escalate—do not approve structural work yourself.”</p>
        ...
        <div className="briefing-note"><b>{learnerName || 'Intern'} · Turnve Site Tablet</b><span>Brief · Site · People · Work</span></div>

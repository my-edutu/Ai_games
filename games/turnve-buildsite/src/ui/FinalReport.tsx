...
export function FinalReport() {
  ...
  const exportJson = () => {
    const blob = new Blob([JSON.stringify({ learnerName, scenario: 'concrete-pour-decision', state, practical, report }, null, 2)], { type: 'application/json' });

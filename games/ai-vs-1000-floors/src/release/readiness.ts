...
import{FLOORS_CONTENT_VERSION,FLOORS_DETERMINISTIC_VERSION,FLOORS_INFLUENCE_VERSION,FLOORS_PRESENTATION_VERSION}from'../version';
...
export interface FloorsReleaseManifest{gameId:'ai-vs-1000-floors';candidateSha:string;createdAt:string;deterministicVersion:typeof FLOORS_DETERMINISTIC_VERSION;configVersion:1;contentVersion:typeof FLOORS_CONTENT_VERSION;presentationVersion:typeof FLOORS_PRESENTATION_VERSION;influenceVersion:typeof FLOORS_INFLUENCE_VERSION;commands:string[];artifactDigests:Record<string,string>;manifestDigest:string}
...
export function buildFloorsReleaseManifest(input:FloorsReleaseManifestInput):FloorsReleaseManifest{
  ...
  const base={gameId:'ai-vs-1000-floors' as const,candidateSha:input.candidateSha,createdAt:input.createdAt,deterministicVersion:FLOORS_DETERMINISTIC_VERSION,configVersion:1 as const,contentVersion:FLOORS_CONTENT_VERSION,presentationVersion:FLOORS_PRESENTATION_VERSION,influenceVersion:FLOORS_INFLUENCE_VERSION,commands:[...input.commands],artifactDigests:{...input.artifactDigests}};

...
export function parseMarbleConfig(input: Partial<MarbleConfig> = {}): MarbleConfig {
  ...
  const config: MarbleConfig = {
    ...
    gravityPerTick: integer('gravityPerTick', input.gravityPerTick ?? DEFAULTS.gravityPerTick, 1, 200),
    maxVerticalSpeed: integer('maxVerticalSpeed', input.maxVerticalSpeed ?? DEFAULTS.maxVerticalSpeed, 40, 4_000),
